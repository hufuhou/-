    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          <h1>😎创鑫仓储管理系统😎</h1>
          <p>创鑫WMS仓储管理系统的目标是帮助企业优化仓储流程，提高仓库管理效率，降低运营成本，并且为企业提供全面的仓储数据分析和统计报表，助力企业制定更科学的运营决策。通过引入现代化的技术和微服务架构，我们致力于打造一套适应不同规模和业务需求的仓储管理系统</p>
        </blockquote>
        <hr/>
      </el-col>
    </el-row>
  ...
  methods: {
    ...
    async getCountValue() {
      try {
        ...
        // 循环 wId 数组，以数组中的每个元素作为参数调用 findCountValue 方法
